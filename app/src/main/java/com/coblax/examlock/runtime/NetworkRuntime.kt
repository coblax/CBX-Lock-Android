...
import com.coblax.examlock.model.BatteryDiagnostics
...
internal suspend fun readNetworkReadinessStatusWithProbe(
    ...
    val effectiveVerdict =
        if (baseStatus.verdict == NetworkReadinessVerdict.ConnectedStable &&
            dnsProbeFailedOrTimedOut(globalProbeStatus) &&
            dnsProbeFailedOrTimedOut(probeStatus)
        ) {
