...
import com.coblax.examlock.ExamPolicyEngine
...
import com.coblax.examlock.PinningActivationGraceWindowMillis
...
import com.coblax.examlock.ScreenPinningSignals
...
import com.coblax.examlock.runtime.getExternalDisplayCount
...
import com.coblax.examlock.runtime.isInAnySplitMode
...
internal class ExamRuntimeStartPrecheckCallbacks(
    val recordAction: (String, String, DiagnosticEventLevel) -> Unit,
    val applyVirtualEnvironmentDiagnostics: (com.coblax.examlock.model.VirtualEnvironmentDiagnostics, Boolean) -> Unit,
...
internal fun completeExamRuntimeStartAfterPrechecks(
    ...
    deviceCompatibilityProfile: com.coblax.examlock.DeviceCompatibilityProfile,
