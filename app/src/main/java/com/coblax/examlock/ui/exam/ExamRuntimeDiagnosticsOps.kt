...
import com.coblax.examlock.config.LowMaxNetworkTimelineEntries
import com.coblax.examlock.config.MaxNetworkTimelineEntries
import com.coblax.examlock.config.NetworkUnstableFlipThreshold
import com.coblax.examlock.config.NetworkUnstableWindowMillis
import com.coblax.examlock.config.UltraMaxNetworkTimelineEntries
...
internal class ExamRuntimeDiagnosticsOps(
    ...
    private val batteryStatusState: MutableState<com.coblax.examlock.model.ExamBatteryStatus>? = null
) {
