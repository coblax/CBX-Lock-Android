...
import com.coblax.examlock.openInternetConnectivitySettings
...
import com.coblax.examlock.showKeyboardPicker
...
internal fun buildExamDiagnosticSnapshotForSession(
    context: Context,
    source: String,
    lowRamProfile: com.coblax.examlock.LowRamProfile,
    ...
    preExamHealthSnapshot: com.coblax.examlock.ui.preparation.PreExamHealthSnapshot,
