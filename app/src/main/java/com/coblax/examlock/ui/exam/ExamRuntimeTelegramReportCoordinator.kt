...
internal class ExamRuntimeTelegramReportCallbacks(
    ...
    val refreshDeviceTimeSecurity: () -> com.coblax.examlock.DeviceTimeSecurityStatus,
    val refreshGeofenceStatus: suspend () -> com.coblax.examlock.SplitLocationSecurityStatus,
...
internal fun launchExamRuntimeTelegramSectionReport(
    ...
    webViewCompatibilityStatus: com.coblax.examlock.WebViewCompatibilityStatus,
