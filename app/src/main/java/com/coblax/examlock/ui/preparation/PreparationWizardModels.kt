...
import com.coblax.examlock.ui.performance.shouldBuildFullPreparationPayload
...
internal enum class WizardStep(
    ...
    fun shortLabel(lang: UiLanguage): String = localized(lang, shortLabelEN, shortLabelID)
}
